...
class Evaluate(unittest.TestCase):
    def test_calculate(self):
        self.assertEqual(functions.calculate(make_float=False, operation='add', message='You just added', first=2, second=4), "You just added 6")
        self.assertEqual(functions.calculate(make_float=True, operation='divide', first=3.5, second=5), "The result is 0.7")
    ...
    def test_extract_full_name(self):
        ...
        self.assertEqual(functions.extract_full_name(names), ['Elie Schoppik', 'Colt Steele'])
