...
class Evaluate(unittest.TestCase):
    ...
    def test_list_manipulation(self):
        self.assertEqual(functions.list_manipulation(
            [1, 2, 3], "remove", "end"), 3)
        self.assertEqual(functions.list_manipulation(
            [1, 2, 3], "remove", "beginning"), 1)
        self.assertEqual(functions.list_manipulation(
            [1, 2, 3], "add", "beginning", 20), [20, 1, 2, 3])
        self.assertEqual(functions.list_manipulation(
            [1, 2, 3], "add", "end", 30), [1, 2, 3, 30])
    ...
    def test_compact(self):
        self.assertEqual(functions.compact(
            [0, 1, 2, "", [], False, {}, None, "All done"]), [1, 2, "All done"])
    ...
    def test_partition(self):
        ...
        self.assertEqual(functions.partition(
            [1, 2, 3, 4], isEven), [[2, 4], [1, 3]])

    def test_mode(self):
        self.assertEqual(functions.mode(
            [2, 4, 1, 2, 3, 3, 4, 4, 5, 4, 4, 6, 4, 6, 7, 4]), 4)
