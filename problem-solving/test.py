...
class Evaluate(unittest.TestCase):
    ...
    def test_list_check(self):
        self.assertEqual(functions.list_check([[],[1],[2,3], (1,2)]), False)
        self.assertEqual(functions.list_check([1, True, [],[1],[2,3]]), False)
        self.assertEqual(functions.list_check([[],[1],[2,3]]), True)


    def test_remove_every_other(self):
        self.assertEqual(functions.remove_every_other([1,2,3,4,5]), [1,3,5])
        self.assertEqual(functions.remove_every_other([5,1,2,4,1]), [5,2,1])
    ...
    def test_vowel_count(self):
        self.assertEqual(functions.vowel_count('awesome'), {'a': 1, 'e': 2, 'o': 1})
    ...
    def test_titleize(self):
        self.assertEqual(functions.titleize('this is awesome'), "This Is Awesome")
        self.assertEqual(functions.titleize('oNLy cAPITALIZe fIRSt'), "ONLy CAPITALIZe FIRSt")
    ...
    def test_truncate(self):
        self.assertEqual(functions.truncate("Super cool", 2), "Truncation must be at least 3 characters.")
        self.assertEqual(functions.truncate("Super cool", 1), "Truncation must be at least 3 characters.")
        self.assertEqual(functions.truncate("Super cool", 0), "Truncation must be at least 3 characters.")
        self.assertEqual(functions.truncate("Hello World", 6), "Hel...")
        self.assertEqual(functions.truncate("Problem solving is the best!", 10), "Problem...")
        self.assertEqual(functions.truncate("Another test", 12), "Another t...")
        ...
        self.assertEqual(functions.truncate("Holy guacamole!", 152), "Holy guacamole!")


    def test_two_list_dictionary(self):
        self.assertEqual(functions.two_list_dictionary(['a', 'b', 'c', 'd'], [1, 2, 3]), {'a': 1, 'b': 2, 'c': 3, 'd': None})
        self.assertEqual(functions.two_list_dictionary(['a', 'b', 'c']  , [1, 2, 3, 4]), {'a': 1, 'b': 2, 'c': 3})
        self.assertEqual(functions.two_list_dictionary(['x', 'y', 'z']  , [1,2]), {'x': 1, 'y': 2, 'z': None})
    ...
    def test_find_the_duplicate(self):
        ...
        self.assertEqual(functions.find_the_duplicate([6,1,9,5,3,4,9]), 9)
    ...
    def test_min_max_key_in_dictionary(self):
        self.assertEqual(functions.min_max_key_in_dictionary({2:'a', 7:'b', 1:'c',10:'d',4:'e'}), [1,10])
        self.assertEqual(functions.min_max_key_in_dictionary({1: "Elie", 4:"Matt", 3: "Tim"}), [1,4])
    ...
    def test_two_oldest_ages(self):
        ...
        self.assertEqual(functions.two_oldest_ages( [4,25,3,20,19,5] ), [20,25])
    ...
    def test_three_odd_numbers(self):
        ...
        self.assertEqual(functions.three_odd_numbers([0,-2,4,1,9,12,4,1,0]), True)
